...
[![npm version](https://badge.fury.io/js/%40jhangyu%2Fclaude-code-router.svg)](https://www.npmjs.com/package/@jhangyu/claude-code-router)
![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)
![Node Version](https://img.shields.io/node/v/@jhangyu/claude-code-router.svg)
...
- **CLI** (`@jhangyu/claude-code-router`): 提供 `ccr` 命令的命令行工具
...
MIT © [jhangyu](https://github.com/jhangyu)
